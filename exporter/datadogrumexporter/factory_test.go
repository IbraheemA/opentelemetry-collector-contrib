...
func TestCreateAPIExporterFailOnInvalidKey_Zorkian(t *testing.T) {
	featuregateErr := featuregate.GlobalRegistry().Set("exporter.datadogrumexporter.UseLogsAgentExporter", false)
	...
	featuregateErr = featuregate.GlobalRegistry().Set("exporter.datadogrumexporter.UseLogsAgentExporter", true)
	assert.NoError(t, featuregateErr)
}
